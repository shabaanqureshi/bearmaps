...
public class MapServer {
     ...
     **/
    private static String[] REQUIRED_RASTER_RESULT_PARAMS = new String[6];
    ...
    public static void initialize() {
        REQUIRED_RASTER_RESULT_PARAMS[0] = "render_grid";
        REQUIRED_RASTER_RESULT_PARAMS[1] = "raster_ul_lon";
        REQUIRED_RASTER_RESULT_PARAMS[2] = "raster_ul_lat";
        REQUIRED_RASTER_RESULT_PARAMS[3] = "raster_lr_lon";
        REQUIRED_RASTER_RESULT_PARAMS[4] = "raster_lr_lat";
        REQUIRED_RASTER_RESULT_PARAMS[5] = "depth";
        REQUIRED_RASTER_RESULT_PARAMS[5] = "query_success";
